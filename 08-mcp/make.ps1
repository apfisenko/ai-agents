...
param(
    ...
    [ValidateSet("install", "run", "run-mcp-bank", "stop-mcp-bank", "check-mcp-bank", "check-bot", "stop-bot", "smoke-index", "smoke-rag-chain", "dataset", "dataset-upload", "docker-build", "docker-up", "docker-down", "docker-up-host", "docker-down-host", "docker-ps", "docker-check", "docker-windows-host-ip", "docker-portproxy-hint", "portproxy-up", "portproxy-down", "help")]
    [string] $Target = "help",
