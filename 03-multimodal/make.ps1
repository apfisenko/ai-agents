...
param(
    ...
    [ValidateSet("install", "run", "docker-build", "docker-up", "docker-down", "docker-up-host", "docker-down-host", "docker-ps", "docker-check", "docker-windows-host-ip", "docker-portproxy-hint", "portproxy-up", "portproxy-down", "help")]
    [string] $Target = "help",
